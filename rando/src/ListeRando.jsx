  ...
  useEffect(() => {
    ...
    const chargerDonnees = async () => {
      try {
        ...
        //selon la vraie structure de JSON :
        ...
        // composant a déjà été démonte entre-temps.
        if (!ignore) {
          setChargement(false)
        }
      }
    ...
    // Fonction de "nettoyage" : React l'exécuter automatiquement quand
    // le composant est démontée. On y passe
